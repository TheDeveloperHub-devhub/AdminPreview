...
namespace DeveloperHub\AdminPreview\Block\Adminhtml\Category\Edit\Button;

use Magento\Catalog\Helper\Data;
use Magento\Framework\App\Request\Http;
use Magento\Framework\AuthorizationInterface;
use Magento\Framework\View\Element\UiComponent\Control\ButtonProviderInterface;
use DeveloperHub\AdminPreview\Helper\Data as AdminPreviewHelper;
use DeveloperHub\AdminPreview\Plugin\FrontendUrl;

/**
 * Class CategoryPreview
 * @package DeveloperHub\AdminPreview\Block\Adminhtml\Category\Edit\Button
 */
class CategoryPreview implements ButtonProviderInterface
{
     ...
     */
    private const ADMIN_RESOURCE_NAME = 'DeveloperHub_AdminPreview::config';
